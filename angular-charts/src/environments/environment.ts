export const environment = {
  production: true,
  // OLD VARIABLES:
  // API_URL_PAISES_OLD: 'http://3.139.132.46:3001/api/paises/',
  // API_URL_PROVINCIAS_OLD: 'http://3.139.132.46:3001/api/provincias/',
  // API_URL_LOCALIDADES_OLD: 'http://3.139.132.46:3001/api/localidad/',
  ...
  API_URL_RGENERALTS: 'http://3.139.132.46:3001/api/registro-general-ts/',
  ...
  API_URL_TRIGGER: 'http://3.139.132.46:3001/api/trigger/',
  API_URL_RTOKEN: 'http://3.139.132.46:3001/api/refresh',
